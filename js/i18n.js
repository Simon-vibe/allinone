const translations = {
    ...
    es: {
        ...
        "prompt.seo.h2": "Dominando Prompts de Midjourney",
        "prompt.label.mode": "Modo:",
        "prompt.mode.claude": "Claude (XML)",
        "prompt.mode.chatgpt": "ChatGPT (Markdown)",
        "prompt.label.preset": "Cargar Preset:",
        "prompt.preset.custom": "Personalizado...",
        "prompt.preset.refactor": "Refactorizar Código",
        "prompt.preset.polish": "Mejorar Artículo",
        "prompt.preset.analyze": "Análisis de Datos",
        "prompt.label.role": "Rol (¿Quién es la IA?)",
        "prompt.ph.role": "ej. Experto Desarrollador Python",
        "prompt.label.context": "Contexto (Información de fondo)",
        "prompt.ph.context": "ej. Trabajando en un proyecto Django legado...",
        "prompt.label.task": "Tarea (¿Qué hacer?)",
        "prompt.ph.task": "ej. Refactorizar la siguiente función...",
        "prompt.label.constraints": "Restricciones (Reglas)",
        "prompt.ph.constraints": "ej. No usar librerías externas.",
        "prompt.label.format": "Formato de Salida",
        "prompt.ph.format": "ej. Solo JSON, o Función Python única",
        "prompt.preview.title": "VISTA PREVIA",
        ...
        "md.error.fetch": "Error al obtener URL. Puede estar bloqueada. Intente pegar el código fuente manualmente.",
        "md.error.parse": "Conversión fallida. Asegúrese de que el HTML sea válido.",
        ...
        "qr.label.fg_color": "Color Frontal",
